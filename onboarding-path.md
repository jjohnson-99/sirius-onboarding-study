...
- [ ] **Days 1–2 — Entry → plan** (keep `execution-flow.md` open):
  - [ ] `src/sirius_extension.cpp` — *skim*; large (~1,700 lines) but mostly
        registration/config boilerplate
  - [ ] `src/sirius_interface.cpp` — *read*; DuckDB-facing API, query lifecycle
