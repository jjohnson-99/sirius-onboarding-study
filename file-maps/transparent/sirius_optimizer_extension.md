...
Read this **right after** [`../sirius_extension.md`](../sirius_extension.md): that file
...
onward ([`../sirius_interface.md`](../sirius_interface.md) → engine → operators) is
...
| 2. `OnFinalizePrepare` — swap DuckDB's physical plan for a Sirius one | `sirius_context.cpp` | [`../sirius_context.md`](../sirius_context.md) (Role 2) |
...
Full treatment in [`../sirius_context.md`](../sirius_context.md).
...
- **`sirius_interface` / `sirius_prepared_statement_data`** *(Sirius)* — the shared
  engine entry; detail in [`../sirius_interface.md`](../sirius_interface.md). **Think:**
...
converge there, the rest of Week 2 ([`../sirius_interface.md`](../sirius_interface.md)
