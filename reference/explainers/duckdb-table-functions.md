...
[`../duckdb-types-glossary.md`](../duckdb-types-glossary.md) bind→execute entries, and
...
The four [`../duckdb-types-glossary.md`](../duckdb-types-glossary.md) types are exactly
