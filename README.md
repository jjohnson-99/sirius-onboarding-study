...
| [reference/explainers/](reference/explainers/README.md) | Long-form background concepts intuitive to DB folks but not assumed of the reader — table functions, columnar vs. row storage, vectorized execution, Parquet. One topic per file; pull up as needed. |
